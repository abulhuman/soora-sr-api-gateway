...
import { AuthServiceClient, RegisterResponse, RegisterRequest, AUTH_SERVICE_NAME, LoginRequest, LoginResponse, ValidateRequest, ValidateResponse } from './auth.pb';
...
export class AuthController implements OnModuleInit {
  ...
  @Get('validate')
  private async validate(@Query('token') token: string): Promise<Observable<ValidateResponse>> {
